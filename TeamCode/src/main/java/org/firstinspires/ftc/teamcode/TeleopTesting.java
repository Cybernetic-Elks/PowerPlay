...
public class TeleopTesting extends LinearOpMode
{
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive())
        {
            ...
            h.setDrivePower((float) PID.output(10000, h.motorFrontLeft.getCurrentPosition()));
            //h.driveFieldRelative(gamepad1.left_stick_x, gamepad1.left_stick_y, gamepad1.right_stick_x, slow, .3, .8);
        }
    }
}

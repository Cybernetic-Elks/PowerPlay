...
public class SignalTagDetector extends OpenCvPipeline {
    /**
     * Programmer:    Sean Pakros
     * Date Created:  12/27/212
     * Purpose: Code for detecting the signal sleeve using AprilTags through OpenCV.
     */
    Telemetry telemetry;
    Mat mat = new Mat();
    public enum Side {
    ...
    public SignalTagDetector(Telemetry t) { telemetry = t; }
